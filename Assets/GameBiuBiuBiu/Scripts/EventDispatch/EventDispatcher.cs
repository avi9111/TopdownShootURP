...
//参考：https://blog.csdn.net/weixin_42422809/article/details/84886730
public class EventDispatcher : SpecSingleton<EventDispatcher>
{
    ...
    public void DispatchEvent(int evt)
    {
        ...
        try
        {
            ...
            {
                var act = (Act)func;//TODO:现在里面报错了，好像不会提示，只会提示外面的堆栈
                act();
            }
        }
        catch (Exception e)
        {
            Debug.LogError("可能是实现事件代码出错：" + "error Dispatch evt id=" + evt);
